...
/** URDF -> EusLisp: drop a URDF and its meshes, get a .l model back. */
export default function Urdf2Eus({ worker }: { worker: Worker | null }) {
  ...
  }, [worker, urdfName, urdfText, meshes, robotName, useUrdfMaterial]);
