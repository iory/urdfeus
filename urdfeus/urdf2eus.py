...
from urdfeus.provenance import header_lines
...
;;
;; Which code produced this, for bug reports. A shim in ~/.local/bin and a
;; checkout in the working directory can be different versions of the same
;; package, so the paths matter as much as the version numbers.""",
        file=fp,
    )
